...
def print_oi(num,step,nearest,url):
    global total_coi_put, total_coi_call
        ...
        if item["expiryDate"] == currExpiryDate:
            if item["strikePrice"] == strike and item["strikePrice"] < start_strike+(step*num*2):
                ...
                print(data["records"]["expiryDates"][0] + " " + str(item["strikePrice"]) + " CE " + "[ " + strBold(str(item["CE"]["openInterest"]).rjust(10," ")) + " ]" + " PE " + "[ " + strBold(str(item["PE"]["openInterest"]).rjust(10," ")) + " ]" +
                      "    " + " CE " + "[ " + strBold(str(item["CE"]["changeinOpenInterest"]).rjust(10," ")) + " ]" + " PE " + "[ " + strBold(str(item["PE"]["changeinOpenInterest"]).rjust(10," ")) + " ]"
                      "    " + " CE " + "[ " + strBold(str(item["CE"]["pchangeinOpenInterest"]).rjust(10," ")) + " ]" + " PE " + "[ " + strBold(str(item["PE"]["pchangeinOpenInterest"]).rjust(10," ")) + " ]")

                total_coi_put = total_coi_put + item["PE"]["changeinOpenInterest"]
                total_coi_call = total_coi_call + item["CE"]["changeinOpenInterest"]
                strike = strike + step
...
for _ in range(100):
    ...
    print(strCyan(str("Total Change COI PUT:")) + str(total_coi_put))
    print(strCyan(str("Total Change COI CALL:")) + str(total_coi_call))
    total_coi_put = 0
    total_coi_call = 0
    sleep(120)
